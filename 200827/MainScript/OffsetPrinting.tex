...
We used the {\it paired t-test}\cite{Rice} to verify the efficiency of the algorithm. The paired t-test is one of the two sample t-test, and it is a test that verifies whether the two groups are different. The two populations are as follows.
