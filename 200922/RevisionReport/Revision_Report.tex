...
\noindent{\bf L25--26 in P1 : 애매해 반영 안 함} 
...
\noindent $\longrightarrow$ {\color{red}The a}bove example {\color{red}denotes} what is the best arrangement \\
...
\noindent{\bf L47 in P2 : 이 이외의 number of labels에는 체크가 없어서 반영 안 함} 
...
\noindent{\bf L66--67 in P3 : 뜻이 애매해 반영 안 함} 

\noindent First, one type of label should be placed on \sout{only} one plate. 

\noindent $\longrightarrow$ First, {\color{red}only} one type of label should be placed on one plate. \\

\noindent{\bf L74 in P3 : } 

\noindent minimized as \sout{little as} $\longrightarrow$ {\color{red}as} minimized as \\

\noindent{\bf L75 in P3 : Loss는 defined 고유명사 같은 것 - 반영 안 할 것} 

\noindent the \xcancel{L}oss should be minimized $\longrightarrow$ the {\color{red}l}oss should be minimized \\
...
\noindent $\longrightarrow$ Then, the calculation takes more than 658 hours, \\
...
\noindent the efficiency as the follow formula. $\longrightarrow$ the efficiency as the follow{\color{red}ing} formula. \\
...
\noindent{\bf L216--218 in P11 : 저자에 김현민 교수님 있으므로 thanks to 에서 제외} 

\noindent The authors extend thanks to \sout{Professor Hyun-Min Kim and} Professor Sang-il Kim of Pusan National University who provided \sout{many} support and \sout{advises} for \sout{the} writing of this paper.

\noindent $\longrightarrow$ The authors extend thanks to Professor Sang-il Kim of Pusan National University who provided {\color{red}much} support and {\color{red}advice} for writing of this paper. \\
