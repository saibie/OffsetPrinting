...
\noindent{\bf L120 in P4 : } 

\noindent $P$ is the set of products \sout{that contains} the Plate

\noindent $\longrightarrow$ $P$ is the set of products {\color{red}which are contained in} the Plate\\

\noindent{\bf L121--122 in P4 : } 

\noindent \sout{each plate does not have the same product.}

\noindent $\longrightarrow$ {\color{red}one type of label should be placed on only one plate.}\\
