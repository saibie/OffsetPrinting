...
$P$, which is one of the results of ${loop}(k, z, num)$, is the set of products which are contained in the Plate (see Figure \ref{fig:SFChart}). 
...
{\bf Notice.} Please note that the detailed idea of the algorithm cannot be described for company confidentiality reasons.
...
The authors extend thanks to Professor Sang-il Kim of Pusan National University who provided much support and advice for writing of this paper.}
